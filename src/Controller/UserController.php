...
use Symfony\Component\Routing\Attribute\Route; // ← important en PHP 8+
...
public function editorRoleRemove(EntityManagerInterface $entityManager, User $user): Response
{
    ...
    $this->addFlash(type: 'success', message: 'Le rôle éditeur a été retiré à votre utilisateur');
...
public function userRemove(EntityManagerInterface $entityManager, $id, UserRepository $userRepository): Response
{
    ...
    $this->addFlash('danger', 'message', 'votre utilisateur a été supprimé');
